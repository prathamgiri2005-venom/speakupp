...
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "https://speakupp-dusky.vercel.app",
        "https://speakupp.in",
        "https://www.speakupp.in",
        "*"
    ],
...
async def send_confirmation_email(name: str, email: str, plan: str, amount: int, meet_link: str):
    ...
    try:
        ...
        msg['Subject'] = "Your Speakupp Class is Confirmed! 🎉"
        msg['From'] = EMAIL_USER
        msg['To'] = email
        ...
        <body style="font-family: Arial, sans-serif; background-color: #f0fdfa; padding: 20px;">
            <div style="max-width: 600px; margin: 0 auto; background: white; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
                <div style="background: linear-gradient(135deg, #14b8a6, #0d9488); padding: 40px; text-align: center;">
                    <h1 style="color: white; margin: 0; font-size: 28px;">SpeakUpp</h1>
                    <p style="color: rgba(255,255,255,0.9); margin: 10px 0 0 0;">Your Confidence Journey Begins!</p>
                </div>
                <div style="padding: 40px;">
                    <h2 style="color: #1a1a2e;">Hi {name}! 👋</h2>
                    <div style="background: #f0fdfa; border-radius: 12px; padding: 25px; text-align: center; margin: 20px 0;">
                        <p style="font-size: 20px; color: #14b8a6; font-weight: bold; margin: 0;">🎊 Your Seat is Confirmed!</p>
                    </div>
                    <table style="width: 100%; margin: 25px 0; border-collapse: collapse;">
                        <tr>
                            ...
                            <td style="padding: 12px 0; border-bottom: 1px solid #e5e7eb; font-weight: 600; text-align: right;">{plan}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="padding: 12px 0; font-weight: 600; text-align: right;">7:00 PM IST</td>
                        </tr>
                    </table>
